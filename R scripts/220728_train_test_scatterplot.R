...
yolo <- read_csv("data/220728/d50_Train1_Prediction1_40.csv") %>% 
  clean_names() %>% 
...
m = round(summary(lm(test ~ train, data = plot_yolo))[[4]][2, 1], 1)
b = round(summary(lm(test ~ train, data = plot_yolo))[[4]][1, 1], 1)
